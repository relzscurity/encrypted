...
local ESP = Library:Tab("Esp","rbxassetid://7733774602") --7733774602
...
ESP:Toggle("Esp Mirage Island", false, function(value)
...
ESP:Toggle("Esp Advanced Fruit Dealer", false, function(value)
    AfdESP = value
...
ESP:Toggle("Esp Gear [Beta]", false, function(value)
    GearESP = value
